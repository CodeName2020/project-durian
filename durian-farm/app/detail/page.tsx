  ...
  return (
    <section className="space-y-12 overflow-hidden">
      ...
      <div className='relative flex items-center justify-center'>
        ...
        <div className='absolute left-0 top-0 h-full w-2/3 flex items-center justify-center'>
          <div className='font-bold'>
            <div className='flex space-x-8'>
              <div className='bg-white flex flex-col w-6/7 px-4 py-8 space-y-2'>
                <div className=''>
                  <Image src={Ico1} alt={'Farm Page 4'} className='w-[30px] h-[34px]' priority={true} />
                </div>
                <div>
                  <h2 className="text-6xl">{<ReadTreeCF farmId={'2TZyg8ml44iNsV4NFut5'} />} ต้น</h2>
                  <p className="text-gray-600 text-2xl">จำนวนต้นทุเรียน</p>
                </div>
              </div>
              <div className='bg-white flex flex-col w-6/7 px-4 py-8 space-y-2'>
                <div className=''>
                ...
                <div>
                  <h2 className="text-6xl">{<ReadToCFirestore farmId={'2TZyg8ml44iNsV4NFut5'} />} ลูก</h2>
                  <p className="text-gray-600 text-2xl">จำนวนผล</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='absolute right-0 top-0 h-full w-1/2 flex items-start justify-center'>
          <div className='flex flex-col h-auto w-2/4 text-start p-6 bg-white'>
            <div className='font-bold text-4xl'>สถานะ : พร้อมที่จะทำการเก็บเกี่ยวแล้ว</div>
            <div className='space-y-4'>
              <div>
                <p className="text-2xl text-green-500 mt-12">เก็บแล้ว {<ReadCollected farmId={'2TZyg8ml44iNsV4NFut5'} />} ลูก</p>
              ...
              <div>
                <p className="text-2xl">พร้อมที่จะเก็บ {<ReadCollecting farmId={'2TZyg8ml44iNsV4NFut5'} />} ลูก</p>
                <div className="w-full h-6 border-black border-2 p-0.5 rounded-full overflow-hidden">
                  <div className="bg-black h-full w-1/4 rounded-full"></div>
                </div>
              </div>
              <div>
                <p className="text-2xl text-red-800">ยังไม่พร้อมที่จะเก็บ {<ReadNotReady farmId={'2TZyg8ml44iNsV4NFut5'} />} ลูก</p>
                <div className="w-full h-6 border-black border-2 mb-8 p-0.5 rounded-full overflow-hidden">
                  <div className="bg-red-800 h-full w-1/5 rounded-full"></div>
                </div>
              </div>
              <p className="text-2xl">ผสมเกสรเมื่อ 24 มิถุนายน 2565</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col items-center'>
        ...
        <div className='mt-8'>
          <button className="ml-2 border-2 w-96 border-black text-black text-3xl py-4 px-6 rounded-full">
