        ...
        <section className="container flex mx-auto">
            ...
            <div className="w-1/2 flex flex-col justify-center px-8">
                ...
                <h1 className="text-9xl justify-start font-bold bg-yellow-500 text-white py-2 mb-12">
                    <div className="flex px-2 justify-center">
                        <svg width="755" height="156" viewBox="0 0 755 156" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M424.331 6.47818L410.031 11.0016V82.7935V154.731H425.352H440.673V78.1241C440.673 35.9537 440.236 1.66287 439.652 1.66287C438.922 1.80879 432.064 3.85165 424.331 6.47818Z" fill="white" />
                        </svg>
                    </div>
                </h1>
                <p className="text-3xl">
                    แพลตฟอร์มฟาร์มทุเรียนของเราถูกออกแบบเพื่อให้บริการ
                ...
                <div className="mt-6 flex space-x-4">
                    ...
                    <button className="w-1/3 border border-black text-black flex items-center text-3xl justify-center font-semibold py-4 px-4 rounded-full">
                        เกี่ยวกับ
                    </button>
                </div>
