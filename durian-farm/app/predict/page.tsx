        ...
        <section className="container flex mx-auto flex-col">
            ...
            <div className='flex justify-center'>
                <div className="flex flex-row justify-center">
                    <h1 className="text-9xl">ทำนายผลผลิต</h1>
                </div>
            </div>
            <div className='flex justify-center'>
                <div className='mb-4'>
            ...
            <div className='flex justify-center my-8'>
                <div className='grid place-items-end mr-2'>
                    <input type="number" className="border-2 border-yellow-500 text-4xl text-yellow-500 block text-center w-52"
                        placeholder="วัน"
                        required
                    />
                </div>
                <div className='flex items-center text-4xl justify-start lg:mr-8'>
            ...
            <div className='flex justify-center space-x-8 mt-6'>
                <nav className=''>
                    <ul className="flex items-center -space-x-px h-full text-3xl">
                        <li>
                            <a href="#" className="flex items-center justify-center px-4 h-16 ml-0  border-2 border-black rounded-l-lg hover:bg-gray-100 hover:text-gray-700">
                        ...
                        <li>
                            <a href="#" className="flex items-center justify-center px-4 h-16 text-gray-500  border-2 border-black hover:bg-gray-100 hover:text-black ">1</a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center justify-center px-4 h-16 text-gray-500  border-2 border-black hover:bg-gray-100 hover:text-black ">2</a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center justify-center px-4 h-16 border-2 border-black bg-yellow-50 hover:bg-yellow-100 hover:text-yellow-700">3</a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center justify-center px-4 h-16 border-2 border-black rounded-r-lg hover:bg-gray-100 hover:text-gray-700">
                                <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                ...
                <button className="flex items-center justify-center border-2 text-3xl border-black font-medium py-4 px-6 rounded-full w-80">
                    <svg
                ...
                <button className="bg-yellow-500 text-white flex items-center justify-center text-3xl py-4 px-6 rounded-full w-80">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="44"
                        height="44"
