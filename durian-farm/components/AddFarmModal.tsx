...
import { addFarm } from '@/app/context/WriteDB';

const AddFarmModal = (props: { closePop: any; addFarm: any }) => {
                ...
                <div className='relative bg-white rounded-xl shadow'>
                    ...
                    <div className='px-6 py-6'>
                        <form className='space-y-6' onSubmit={handleSubmit}>
                            ...
                            <div className='w-1/2'>
                                <button type='submit' className='w-full text-yellow-500 hover:text-white text-2xl border-2 border-yellow-500 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-gray-300 py-2 px-4 rounded-xl mt-2'>
                                    เพิ่มฟาร์ม
                                </button>
                            </div>
                        </form>
